...
import 'package:profit_app/screens/trainer/levels/add_level_exercise_screen.dart';
import 'package:profit_app/screens/trainer/levels/edit_level_exercise_screen.dart';

class LevelExercisesScreen extends StatelessWidget {
  final String entrenamientoId;
  final String entrenamientoNombre;

  const LevelExercisesScreen({
    super.key,
          ...
          SimpleDialogOption(
            onPressed: () {
              ...
              Navigator.push(
                ...
                MaterialPageRoute(
                  builder: (_) =>
                      CreateLevelExerciseScreen(entrenamientoId: entrenamientoId),
                ),
              );
            },
            child: const Row(
      ...
      builder: (context) {
        ...
        return AlertDialog(
          ...
          content: StreamBuilder<QuerySnapshot>(
            stream: FirebaseFirestore.instance.collection('ejercicioslvl').snapshots(),
                  ...
                  child: ListTile(
                    ...
                    onTap: () {
                      Navigator.push(
                        ...
                        MaterialPageRoute(
                          builder: (_) =>
                              EditLevelExerciseScreen(ejercicioId: doc.id),
                        ),
                      );
                    },
                  ),
