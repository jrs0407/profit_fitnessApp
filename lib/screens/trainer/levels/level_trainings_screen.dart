...
import 'package:profit_app/screens/trainer/levels/add_level_training_screen.dart';
import 'package:profit_app/screens/trainer/levels/edit_level_trainings_screen.dart';
import 'package:profit_app/screens/trainer/levels/level_exercises_screen.dart';

class LevelTrainingsScreen extends StatelessWidget {
  final String rutinaId;
  final String rutinaNombre;

  const LevelTrainingsScreen({
    super.key,
  ...
  Future<bool?> _confirmDelete(BuildContext context, String entrenamientoId) async {
    if (entrenamientoId.trim().isEmpty) {
    ...
    return Scaffold(
                  ...
                  child: ListTile(
                        ...
                        IconButton(
                          ...
                          onPressed: () {
                            Navigator.push(
                              context,
                              MaterialPageRoute(
                                builder: (_) => EditLevelTrainingScreen(
                    ...
                    onTap: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (_) => LevelExercisesScreen(
                            entrenamientoId: entrenamiento.id,
      ...
      floatingActionButton: FloatingActionButton(
        onPressed: () => Navigator.push(
          context,
          MaterialPageRoute(
            builder: (_) => CreateLevelTrainingScreen(rutinaId: rutinaId),
          ),
        ),
        backgroundColor: const Color(0xFF6A0DAD),
